...
/*function to return root of tree*/
...
void xml_editor()//string name
{
   ...
   // ifstream my_input;
    ...
    string my_string;
  //  my_input.open(name);
    my_output.open("Modification.xml");
...
int i=0;
void create_tree(tree& my_tree)//, string name)
{
...
{
    string s="   ";
    output.open("OUTPUT_FILES/toJson_output.json");
    int x = 1;
    tree my_tree;
    create_tree(my_tree);
